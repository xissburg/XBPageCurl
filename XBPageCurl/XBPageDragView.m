...
@property (nonatomic, strong) XBSnappingPoint *bottomSnappingPoint;
...
- (void)refreshPageCurlView
{
    ...
    point.position = CGPointMake(self.viewToCurl.frame.size.width*0.875, self.viewToCurl.frame.size.height*0.94);
